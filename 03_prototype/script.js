...
// 5. Prototype
function MahasiswaEE(nama, energi) {
    this.nama = nama;
    this.energi = energi;
}

MahasiswaEE.prototype.makan = function(porsi) {
    this.energi += porsi;
    return `Halo, ${this.nama}, selamat makan!`;
}

MahasiswaEE.prototype.main = function(jam) {
    this.energi -= jam;
    return `Halo, ${this.nama}, selamat bermain!`;
}

MahasiswaEE.prototype.tidur = function(jam) {
    this.energi += jam * 2;
    return `Halo, ${this.nama}, selamat tidur!`;
}

let mahasiswaE1 = new MahasiswaEE('Mahasiswa E1', 10);


// 6. veri Class dari Prototype
class MahasiswaFF {
...
let MahasiswaF1 = new MahasiswaFF('MahasiswaF1', 10);
let MahasiswaF2 = new MahasiswaFF('MahasiswaF2', 20);
